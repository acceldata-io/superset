...
| `install_prereqs.sh` | Idempotently installs Python 3.14, Node.js 20, and system libraries |
...
1. **Installs prerequisites** — Python 3.14, Node.js 20, system dev libraries

...
# ---------------------------------------------------------------------------
# Python 3.14 (yum on RHEL, deadsnakes PPA on Ubuntu)
# ---------------------------------------------------------------------------
install_python_rhel() {
    ...
    yum_install python3.14 python3.14-pip python3.14-devel
...
install_python_ubuntu() {
    ...
    apt-get update -y
    apt_install python3.14 python3.14-venv python3.14-dev python3.14-distutils
